                                                      ...
                                                      <div class="accordion-item__container">
                                                            ...
                                                            <div class="col-12 d-sm-flex justify-content-end mt-4">
                                                                  <ul class="nav col-md-4 justify-content-end  d-flex">
                                                                        <li class="accordion-tab" data-actab-group="0" data-actab-id="1"><img src="assets/img/right-arrow.png" width="42" height="42"></li>
                                                                  </ul>
                                                            </div>
                                                      </div>
                                                </article>
                                                            ...
                                                            <div class="row">
                                                                  <div class="col-6 d-sm-flex justify-content-start mt-2">
                                                                        <ul class="nav col-md-4 justify-content-start  d-flex">
                                                                              <li class="accordion-tab" data-actab-group="0" data-actab-id="0"><img src="assets/img/left-arrow.png" width="42" height="42"></li>
                                                                        </ul>
                                                                  </div>
                                                                  <div class="col-6 d-sm-flex justify-content-end mt-2">
                                                                        <ul class="nav col-md-4 justify-content-end  d-flex">
                                                                              <li class="accordion-tab" data-actab-group="0" data-actab-id="2"><img src="assets/img/right-arrow.png" width="42" height="42"></li>
                                                                        </ul>
                                                                  </div>
                                                            </div>
                                                      </div>
                                                ...
                                                <article class="accordion-item" data-actab-group="0" data-actab-id="2">
                                                      ...
                                                      <div class="accordion-item__container">
                                                            ...
                                                            <div class="row">
                                                                  <div class="col-6 d-sm-flex justify-content-start mt-2">
                                                                        <ul class="nav col-md-4 justify-content-start  d-flex">
                                                                              <li class="accordion-tab" data-actab-group="0" data-actab-id="1"><img src="assets/img/left-arrow.png" width="42" height="42"></li>
                                                                        </ul>
                                                                  </div>
                                                                  <div class="col-6 d-sm-flex justify-content-end mt-2">
                                                                        <ul class="nav col-md-4 justify-content-end  d-flex">
                                                                              <li class="accordion-tab" data-actab-group="0" data-actab-id="3"><img src="assets/img/right-arrow.png" width="42" height="42"></li>
                                                                        </ul>
                                                                  </div>
                                                            </div>
                                                      </div>
                                                ...
                                                <article class="accordion-item" data-actab-group="0" data-actab-id="3">
                                                      ...
                                                      <div class="accordion-item__container">
                                                            ...
                                                            <div class="row">
                                                                  <div class="col-6 d-sm-flex justify-content-start mt-2">
                                                                        <ul class="nav col-md-4 justify-content-start  d-flex">
                                                                              <li class="accordion-tab" data-actab-group="0" data-actab-id="2"><img src="assets/img/left-arrow.png" width="42" height="42"></li>
                                                                        </ul>
                                                                  </div>
                                                                  <div class="col-6 d-sm-flex justify-content-end mt-2">
                                                                        <ul class="nav col-md-4 justify-content-end  d-flex">
                                                                              <li class="accordion-tab" data-actab-group="0" data-actab-id="4"><img src="assets/img/right-arrow.png" width="42" height="42"></li>
                                                                        </ul>
                                                                  </div>
                                                            </div>
                                                      </div>
                                                ...
                                                <article class="accordion-item" data-actab-group="0" data-actab-id="4">
                                                      ...
                                                      <div class="accordion-item__container">
                                                            ...
                                                            <div class="row">
                                                                  <div class="col-6 d-sm-flex justify-content-start mt-2">
                                                                        <ul class="nav col-md-4 justify-content-start  d-flex">
                                                                              <li class="accordion-tab" data-actab-group="0" data-actab-id="3"><img src="assets/img/left-arrow.png" width="42" height="42"></li>
                                                                        </ul>
                                                                  </div>
                                                                  <div class="col-6 d-sm-flex justify-content-end mt-2">
                                                                        <ul class="nav col-md-4 justify-content-end  d-flex">
                                                                              <li class="accordion-tab" data-actab-group="0" data-actab-id="5"><img src="assets/img/right-arrow.png" width="42" height="42"></li>
                                                                        </ul>
                                                                  </div>
                                                            </div>
                                                      </div>
                                                      ...
                                                      <div class="accordion-item__container">
                                                            ...
                                                            <div class="row">
                                                                  <div class="col-sm-4 d-flex justify-content-start mt-2 col-md-6 d-sm-flex justify-content-start mt-2">
                                                                        <ul class="nav col-md-4 justify-content-start  d-flex">
                                                                              <li class="accordion-tab" data-actab-group="0" data-actab-id="4"><img src="assets/img/left-arrow.png" width="42" height="42"></li>
                                                                        </ul>
                                                                  </div>
